...
<head>
  ...
  <title>Blood Testing - Hospital Management</title>
...
<body>
  ...
  <div class="jumbotron text-center">
    <h1 class="display-4">Blood Testing</h1>
    <p class="lead">Essential tests for diagnosis and monitoring of health conditions.</p>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 offset-md-2">
        <div class="card">
          <img src="img/blood.jpeg" alt="Blood Testing Image" class="card-img-top">
          <div class="card-body">
            <h2 class="card-title">Comprehensive Blood Tests</h2>
            <p class="card-text">Blood testing plays a crucial role in diagnosing and monitoring various health conditions. At Hospital Management, we offer a wide range of blood tests to assess your overall health and detect potential issues.</p>
            <p class="card-text">Our blood testing services include:</p>
            <ul>
              <li>Complete Blood Count (CBC)</li>
              <li>Blood Chemistry Panel</li>
              <li>Lipid Profile</li>
              <li>Thyroid Function Tests</li>
              <li>Glucose Testing (Blood Sugar)</li>
              <li>Coagulation Studies</li>
            </ul>
            <p class="card-text">Our experienced medical staff ensures accurate and reliable test results. We prioritize patient comfort and safety throughout the testing process.</p>
            <p class="card-text">Schedule your blood test appointment today and take proactive steps towards managing your health.</p>
            <a href="appointment" class="btn btn-primary">Schedule Appointment</a>
          </div>
        </div>
      </div>
    </div>

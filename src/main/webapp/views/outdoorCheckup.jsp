...
<body>
  ...
  <div class="jumbotron text-center">
    <h1 class="display-4">Outdoor Checkup</h1>
    <p class="lead">Take care of your health with our outdoor checkup services.</p>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 offset-md-2">
        <div class="card">
          <img src="img/images.jpeg" class="card-img-top" alt="Outdoor Checkup">
          <div class="card-body">
            <h2 class="card-title">Comprehensive Checkup Services</h2>
            <p class="card-text">Our outdoor checkup services cover a wide range of medical examinations and tests to ensure your well-being.</p>
            <ul>
              <li>Routine health checkups for all ages</li>
              <li>Diagnostic tests including blood pressure, blood sugar, and cholesterol</li>
            ...
            <p class="card-text">We prioritize preventive care and early detection of health issues. Our team of healthcare professionals is dedicated to providing personalized care and guidance for your health and wellness.</p>

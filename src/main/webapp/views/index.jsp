				...
				<div class="col-lg-8 text-center text-lg-start">
					...
					<div class="pt-2">
						<a href="" class="btn btn-light rounded-pill py-md-3 px-md-5 mx-2"
							style="color: #000 !important">The Best Match Services For
							You</a>
		...
		<div class="container">
			<div class="row gx-5">
				...
				<div class="col-lg-7">
					...
					<p>Doctor Sachin Is The Specialist Of The Homeopathic And
						Allopathic Services.</p>
			...
			<div class="row g-5">
				<div class="col-lg-4 col-md-6">
					<div
						...
						<h4 class="mb-3">Treatments</h4>
						<p class="m-0">Viral Fever,Typhoid,Malaria,Inflvenza
							DysenteryGastroenteritis AbdominalColic,EnalColic
							Gastritis,Headache,Arithritis Leg Cramp,Spondylitis
							Hypertension,Diabetes,Hypothyroidism
							Hyperthyroidism,Migeraine,Vertigo
				...
				<div class="col-lg-4 col-md-6">
					<div
						...
						<p class="m-0">Hypopigmentedpatches,Leprosy,
							Tineaversicolor,Vitiligo,Patchasoncheek,
							Urticarialroshest,Urticarialrasher, Generalizeditehing,Dandruff,
							Baldhess, Alopeciaareata,Herpes Zoster, Excessive Loss Alopecia
							Areata, Eczema,Psoriasis,Teniasis, Acne Vulgaris,Sore On Deris</p>
						<a class="btn btn-lg btn-primary rounded-pill" href=""> <i
							class="bi bi-arrow-right"></i>
						</a>
					</div>
				...
				<div class="col-lg-4 col-md-6">
					<div
						...
						<h4 class="mb-3">Psychology Diseases</h4>
						<p class="m-0">Insomnia,Phobia,Hysteria, Anxiety, Depression,
							Forgetfulness, Obsessive Compulsive Neurosis</p>
						<a class="btn btn-lg btn-primary rounded-pill" href=""> <i
							class="bi bi-arrow-right"></i>
						</a>
					</div>
...
<%@ include file="footer.jsp" %>
 ...
 // Add message to chat
    ...
    if (msg.includes("appointment list")) {
        ...
        setTimeout(() => {
            window.location.href = "/admin-dashboard"; // ✅ Update this to your actual URL
        }, 1500);
        return;
    }

    if ((msg.includes("appointment") || msg.includes("book")) && !msg.includes("list")) {
        setTimeout(() => {

			...
			<div class="row g-5">
				<div class="col-lg-4 col-md-6">
					<div
						...
						<p class="m-0">Emergency care is for severe or
							life-threatening cases.</p>
						<a class="btn btn-lg btn-primary rounded-pill"
							href="emergencyCare"><i class="bi bi-arrow-right"></i></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div
						...
						<p class="m-0">Specialized care including skin disease
							surgeries like corn removal.</p>
						<a class="btn btn-lg btn-primary rounded-pill" href="surgery"><i
				...
				<div class="col-lg-4 col-md-6">
					<div
						...
						<p class="m-0">Emergency and outdoor checkup services
							available.</p>
						<a class="btn btn-lg btn-primary rounded-pill"
							href="outdoorCheckup"><i class="bi bi-arrow-right"></i></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div
						...
						<p class="m-0">Onsite pharmacy for better medication
							management.</p>
						<a class="btn btn-lg btn-primary rounded-pill" href="medicine"><i
							class="bi bi-arrow-right"></i></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div
						...
						<p class="m-0">Comprehensive blood testing facilities
							available.</p>
						<a class="btn btn-lg btn-primary rounded-pill"
							href="bloodTesting"><i class="bi bi-arrow-right"></i></a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="owl-carousel testimonial-carousel">
						<div class="testimonial-item text-center">
							...
							<p class="fs-4 fw-normal">The services that I receive from
								(Sai Clinic) is excellent. Dr. (Sharma) and the staff are
